...
from autosemantic.core.base_model import BaseModel
from autosemantic.detection.detection_ontology import DetectionOntology
from autosemantic.helpers import load_image, split_data
