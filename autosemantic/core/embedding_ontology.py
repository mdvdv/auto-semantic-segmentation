...
from autosemantic.core.embedding_model import EmbeddingModel
from autosemantic.core.ontology import Ontology
...
def compare_embeddings(
    ...
    Args:
        image_embedding (np.array): The embedding of the image to compare.
        comparison_embeddings (List[np.array]): A list of embeddings to compare against.
        distance_metric (str): The distance metric to use. Currently only supports "cosine".
...
class EmbeddingOntologyImage(EmbeddingOntology):
    ...
    def process(self, model):
        ...
        for prompt, cls in self.embeddingMap.items():
            ...
            # Get the average of all vectors
